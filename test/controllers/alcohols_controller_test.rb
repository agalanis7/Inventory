...
class AlcoholsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alcohol" do
    assert_difference('Alcohol.count') do
      post alcohols_url, params: { alcohol: { quantity: @alcohol.quantity, title: @alcohol.title } }
    end
  ...
  test "should update alcohol" do
    patch alcohol_url(@alcohol), params: { alcohol: { quantity: @alcohol.quantity, title: @alcohol.title } }
